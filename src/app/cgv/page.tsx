  ...
  return (
    <LegalLayout title="Conditions générales de vente" updatedAt="31 mai 2026">
      ...
      <p>
        ...
        moment, les produits étant facturés sur la base des tarifs en vigueur au
        moment de la commande.
      </p>

      <h2>Article 3 — Commande</h2>
      <p>
        Toute commande passée sur le site vaut acceptation des présentes CGV. Un
        email de confirmation récapitule la commande.
      </p>
