...
export default async function ConfidentialitePage() {
  ...
  return (
    ...
    >
      <LegalContent section="page-confidentialite">
        <p className="rounded-xl border border-gold/30 bg-gold/5 p-4 text-sm text-gold">
          ⚠️ Modèle conforme RGPD à faire valider juridiquement avant
          production.
        </p>
        ...
        <p>
          Nous collectons uniquement les données nécessaires aux services
          suivants :
        </p>
        <ul className="list-disc space-y-1 pl-6">
          ...
          <li>
            <strong>Compte client</strong> : email (connexion par lien
            sécurisé).
          </li>
          <li>
        ...
        <p>
          ...
          recontacter la personne au sujet de sa demande, de son panier ou de
          son essai de commande.
        </p>
        ...
        <p>
          ...
          l&apos;authentification. Les éventuels cookies de mesure
          d&apos;audience ne sont déposés qu&apos;après votre consentement via
          le bandeau dédié.
        </p>
      </LegalContent>
    </LegalLayout>
