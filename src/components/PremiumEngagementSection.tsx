        ...
        <div className="px-4 pb-5 pt-4 sm:px-8 lg:px-8">
          ...
          <div className="hidden sm:block">
            <div className="grid gap-5 lg:grid-cols-[0.78fr_1.22fr] lg:items-stretch">
              <div className="flex flex-col justify-between rounded-3xl border border-gold/25 bg-white/[0.035] p-5">
                <div>
                        ...
                        <div className="flex flex-wrap items-center gap-x-2 gap-y-1">
                          ...
                          >
                            {[1, 2, 3, 4, 5].map((n) => (
                              <Star
                                key={n}
                                className={`h-3.5 w-3.5 ${n <= item.rating ? "fill-gold text-gold" : "text-white/20"}`}
                              />
                            ))}
                          </div>
                        </div>
                        <blockquote className="text-cream/82 mt-2 text-sm leading-6">
